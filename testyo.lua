...
local Library do
    ...
    Library.Unload = function(self)
        ...
        -- Cleanup shared Heartbeat connection
    ...
    Library.CreateColorpicker = function(self, Data)
        ...
        function Colorpicker:SetOpen(Bool)
            ...
            if self.IsOpen then 
                ...
                -- Use shared Heartbeat connection (performance optimization)
                local lastPos = nil
    ...
    do
        ...
        Library.Pages.Section = function(self, Data)
            ...
            local Items = { } do
                ...
                -- Outline at top (0,0) - stays here
                local TopOutline = Instances:Create("Frame", {
                    Parent = Items["Section"].Instance,
                    Name = "\0",
                    Size = UDim2New(1, 0, 0, 2),
                    Position = UDim2New(0, 0, 0, 0),
                    BorderSizePixel = 0,
                    BackgroundColor3 = FromRGB(255, 30, 0)
                })
                TopOutline:AddToTheme({BackgroundColor3 = "Accent"})
                ...
                -- Title background created last so it draws on top of the outline; position at 0,0 so it covers the line on left/right
                local TitleBg = Instances:Create("Frame", {
                    Parent = Items["Section"].Instance,
                    Name = "\0",
                    Size = UDim2New(0, 0, 0, 15),
                ...
                TitleBg:AddToTheme({BackgroundColor3 = "Background"})
                Instances:Create("UIPadding", {
                    Parent = TitleBg.Instance,
                    Name = "\0",
