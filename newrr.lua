...
local Library do
    ...
    Library.CreateColorpicker = function(self, Data)
        ...
        function Colorpicker:SetOpen(Bool)
            ...
            if not colorpickerWindow._cachedDescendants then
                colorpickerWindow._cachedDescendants = colorpickerWindow:GetDescendants()
                TableInsert(colorpickerWindow._cachedDescendants, colorpickerWindow)
            end
            local Descendants = colorpickerWindow._cachedDescendants
    ...
    Library.CreateKeybind = function(self, Data)
        ...
        function Keybind:SetOpen(Bool)
            ...
            if not keybindWindow._cachedDescendants then
                keybindWindow._cachedDescendants = keybindWindow:GetDescendants()
                TableInsert(keybindWindow._cachedDescendants, keybindWindow)
            end
            local Descendants = keybindWindow._cachedDescendants
    ...
    do
        Library.Window = function(self, Data)
            ...
            function Window:SetOpen(Bool)
                ...
                if not mainFrame._cachedDescendants then
                    mainFrame._cachedDescendants = mainFrame:GetDescendants()
                    TableInsert(mainFrame._cachedDescendants, mainFrame)
                end
                local Descendants = mainFrame._cachedDescendants
        ...
        Library.Sections.Dropdown = function(self, Data)
            ...
            function Dropdown:SetOpen(Bool)
                ...
                if not optionHolder._cachedDescendants then
                    optionHolder._cachedDescendants = optionHolder:GetDescendants()
                    TableInsert(optionHolder._cachedDescendants, optionHolder)
                end
                local Descendants = optionHolder._cachedDescendants
